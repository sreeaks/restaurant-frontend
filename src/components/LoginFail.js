...
function LoginFail(){
    ...
    return(
        <section data-testid="login-2">
            <div className="zz">
                <h1 className="tb">Login</h1>
                <h6 className="tb text-danger">Incorrect Username or Password.</h6>
                ...
                <form action="/login" method="POST">
                    <div className='loginRegisterCentered akula'>
                        <span>
                            ...
                            <input type="submit" value="Login" className="inp-text-input-loginReg btn btn-secondary mt-0"/>
                            <div class="register">
